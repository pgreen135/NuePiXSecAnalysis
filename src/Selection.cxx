...
bool Selection::ApplyLooseNeutralPionRejection(int n_showers_contained, float shr_energyFraction, float shr_distance) {
	if (shr_energyFraction > 0.8 && shr_distance < 10) return true;
	else return false;
}
